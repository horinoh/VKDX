...
protected:
	...
	virtual void CreateStaticSampler() override {
		StaticSamplerDescs.push_back({
			...
			0.0f, 1.0f,
			0, 0, D3D12_SHADER_VISIBILITY_DOMAIN
		});
	}
	virtual void CreateRootSignature() override {
		...
		DX::SerializeRootSignature(Blob, {
				...
				{ D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE, { static_cast<UINT>(DRs_Srv.size()), DRs_Srv.data() }, D3D12_SHADER_VISIBILITY_DOMAIN },
			}, {
