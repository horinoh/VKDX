...
void GltfDX::Process(const fx::gltf::Primitive& Prim)
{
	...
	DX::CreatePipelineState_(std::ref(PipelineStates.back()), COM_PTR_GET(Device), RS, ToDXPrimitiveTopologyType(Prim.mode), RTBDs, RD, DSD, VS, PS, NullShaderBC, NullShaderBC, NullShaderBC, IEDs, RTVs);
