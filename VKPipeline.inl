...
template<> void CreatePipeline_Vertex<Vertex_PositionNormalTexcoord>(VkPipeline& PL, const VkPipelineLayout PLL, const VkRenderPass RP,
	const VkShaderModule VS, const VkShaderModule FS, const VkShaderModule TES, const VkShaderModule TCS, const VkShaderModule GS,
	VkPipelineCache PC)
{
	PERFORMANCE_COUNTER();
	...
	VkPipelineCache PC)
{
	...
	const std::array<VkVertexInputBindingDescription, 2> VIBDs = { {
		{ 0, sizeof(Vertex_PositionColor), VK_VERTEX_INPUT_RATE_VERTEX },
