...
#pragma endregion //!< DESCRIPTOR
	...
	virtual void CreateTexture() override {
...

		{
			...
			CreateImage(&Images[0], 0, Type, Format, Extent3D, Levels, Layers, VK_SAMPLE_COUNT_1_BIT, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT | VK_IMAGE_USAGE_STORAGE_BIT);
#if 0
			...
			uint32_t HeapIndex;
			VkDeviceSize Offset;
			SuballocateImageMemory(HeapIndex, Offset, Images[0], VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
#endif
		}

		{
			...
			CreateImageView(&ImageViews[0], Images[0], Type, Format, CompMap, ImageSubresourceRange_ColorAll);
		}
	}
