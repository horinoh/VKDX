...
#pragma region MESH_SHADER
	...
	{
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, ID3D12RootSignature*> pRootSignature;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_SHADER_BYTECODE> AS;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_SHADER_BYTECODE> MS;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_SHADER_BYTECODE> PS;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_BLEND_DESC> BlendState;//D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_BLEND
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, UINT> SampleMask;// D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_SAMPLE_MASK
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_RASTERIZER_DESC> RasterizerState;// D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RASTERIZER 
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_DEPTH_STENCIL_DESC1> DepthStencilState;// D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DEPTH_STENCIL
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_RT_FORMAT_ARRAY> RTVFormats;//D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RENDER_TARGET_FORMATS
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, DXGI_FORMAT> DSVFormat; //D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DEPTH_STENCIL_FORMAT
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, DXGI_SAMPLE_DESC> SampleDesc;//D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_SAMPLE_DESC
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, UINT> NodeMask;//D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_NODE_MASK
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_CACHED_PIPELINE_STATE> CachedPSO;//D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_CACHED_PSO
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_PIPELINE_STATE_FLAGS> Flags;//D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_FLAGS
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_VIEW_INSTANCING_DESC> ViewInstancingDesc;//D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_VIEW_INSTANCING
	};
#pragma endregion
