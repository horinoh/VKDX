...
#pragma region MESH_SHADER
	struct PIPELINE_MESH_STATE_STREAM 
	{
		...
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_BLEND_DESC> BlendState;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, UINT> SampleMask;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_RASTERIZER_DESC> RasterizerState;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_DEPTH_STENCIL_DESC1> DepthStencilState;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_RT_FORMAT_ARRAY> RTVFormats;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, DXGI_FORMAT> DSVFormat;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, DXGI_SAMPLE_DESC> SampleDesc;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, UINT> NodeMask;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_CACHED_PIPELINE_STATE> CachedPSO;
		std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_PIPELINE_STATE_FLAGS> Flags;
		//std::pair<D3D12_PIPELINE_STATE_SUBOBJECT_TYPE, D3D12_VIEW_INSTANCING_DESC> ViewInstancingDesc;
	};
#pragma endregion
