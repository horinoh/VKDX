...
protected:
	...
	virtual void CreatePipelineState() override { PipelineStates.resize(1); CreatePipelineState_VsPs_Vertex_Instance<Vertex_PositionColor, Instance_OffsetXY>(PipelineStates[0]); }
